...
import models.TableModelFilmovi;

/**
 *
 * @author Ari
 */
public class FormPretragaFilma extends javax.swing.JDialog {

    public FormPretragaFilma(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
        setTitle("Pretraga filma");
        TableModelFilmovi model = new TableModelFilmovi();
        Thread th = new Thread(model);
        th.start();
        tblFilmovi.setModel(model);
    }
    ...
    private void initComponents() {
        ...
        btnDetalji.setText("Detalji filma");
    ...
    private void txtPretragaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtPretragaKeyReleased
        ...
        TableModelFilmovi tm = (TableModelFilmovi) tblFilmovi.getModel();
        tm.setParametar(param);
    }//GEN-LAST:event_txtPretragaKeyReleased

    private void btnDetaljiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDetaljiActionPerformed

        int row = tblFilmovi.getSelectedRow();

        if (row >= 0) {
            Film f = ((TableModelFilmovi) tblFilmovi.getModel()).getSelectedFilm(row);
            new FormDetaljiFilma(this, true, f).setVisible(true);
        }
